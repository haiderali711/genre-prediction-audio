...
def predict(filename):
    ...
    model = models.load_model(
        "genre_classification/tests/test_model/prediction_model")
    ...
    scaler = joblib.load(
        'genre_classification/tests/test_model/data_scaler/scaler.bin')
    ...
    encoder.classes_ = np.load(
        'genre_classification/tests/test_model/label_encoder/classes.npy')
